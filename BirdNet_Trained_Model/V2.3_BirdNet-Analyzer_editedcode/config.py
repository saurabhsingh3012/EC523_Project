...
#MODEL_PATH = 'checkpoints/custom/Custom_Classifier.tflite'
#MODEL_PATH = 'checkpoints/custom/ny_tuned_model/Custom_Classifier.tflite'
#MODEL_PATH = 'checkpoints/custom/ny_soundscape_train_subset/top1_Custom_Classifier.tflite'
#MODEL_PATH = 'checkpoints/custom/ny_soundscape_train_subset/top5_Custom_Classifier.tflite'
#MODEL_PATH = 'checkpoints/custom/pregoogle_tuned_model/top5_Custom_Classifier.tflite'
#MODEL_PATH = 'checkpoints/custom/ny_soundscape_subset_trained/Custom_Classifier.tflite'
...
#LABELS_FILE = 'checkpoints/custom/Custom_Classifier_Labels.txt'
#LABELS_FILE = 'checkpoints/custom/ny_soundscape_train_subset/top1_Custom_Classifier_Labels.txt
#LABELS_FILE = 'checkpoints/custom/ny_soundscape_train_subset/top5_Custom_Classifier_Labels.txt'
#LABELS_FILE = 'checkpoints/custom/ny_tuned_model/Custom_Classifier_Labels.txt'
#LABELS_FILE = 'checkpoints/custom/pregoogle_tuned_model/top5_Custom_Classifier_Labels.txt'
#LABELS_FILE = 'checkpoints/custom/ny_soundscape_subset_trained/Custom_Classifier_Labels.txt'
...
#Alice: Change to remove vhstack error
SIG_LENGTH = 1.0
